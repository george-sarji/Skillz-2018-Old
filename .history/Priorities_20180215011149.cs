    ...
    class Priorities : InitializationBot
    {
        ...
        public static int GetWormholeLocationScore(Wormhole wormhole, Location wormholeLocation, Location partner, Pirate pirate)
        {
            ...
            Capsule bestCapsule = myCapsules//Closest Capsule to 
                                ...
                                .FirstOrDefault();
            int distance = GameExtension.WormholePossibleLocationDistance(bestMothership.Location, bestCapsule.Location, wormholeLocation, NewWormholeLocation[wormhole.Partner].Location);
        ...
        public static Location GetPushLocation(Wormhole wormhole, Pirate pirate)
        {
            ...
            var PushLocation= candidates.OrderBy(option => GetWormholeLocationScore(wormhole, option, NewWormholeLocation[wormhole], pirate)).FirstOrDefault();
            NewWormholeLocation[wormhole]=PushLocation;
            return NewWormholeLocation;
        }
    }
}