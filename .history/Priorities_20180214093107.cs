...
namespace Bot
{
    class Priorities : InitializationBot
    {
        ...
        public static int ScaleNumber(double num,int turns)
        {
            if(turns==0)
                return (int)(num*100);
            return (int)(num*100.0*turns);
        }
        ...
        public static int StepsScaled(Wormhole wormhole, int distance)
        {
            ...
            return ScaleNumber(distance/scale,wormhole.TurnsToReactivate);
        }
        ...
        public static int GetWormholeLocationScore(Wormhole wormhole, Location wormholeLocation, Location partner, Pirate pirate)
        {
            ...
            score += ScaleNumber(pirate.Distance(wormhole),wormhole.TurnsToReactivate);
            return score;
        }
