...
namespace Bot
{
    class Priorities : InitializationBot
    {
        ...
        public static int ScaleNumber(double num, int turns, double scale)
        {
            ...
            return (int)(num * 100.0 * turns / scale);
        }
        ...
        public static int GetWormholeLocationScore(Wormhole wormhole, Location wormholeLocation, Location partner, Pirate pirate)
        {
            ...
            score += ScaleNumber(pirate.Distance(wormhole), wormhole.TurnsToReactivate, scale);
            return score;
        }
        ...
        public static Location GetPushLocation(Wormhole wormhole, Pirate pirate)
        {
            ...
            for (int i = 0; i < steps; i++)
            {
                ...
                Location option = wormhole.Location.Add(new Location(deltaX,deltaY));
            ...
            return candidates.OrderByDescending(option => GetWormholeLocationScore(wormhole, option, wormhole.Partner.Location, pirate)).FirstOrDefault();
        }
    }
}